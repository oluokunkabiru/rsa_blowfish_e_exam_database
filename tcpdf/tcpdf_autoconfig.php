...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'../images/oic.png')) {
		$tcpdf_header_logo = '../../images/oic.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'OLUOKUN KABIRU ADESINA');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'OLUOKUN KABIRU ADESINA');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'OLUOKUN KABIRU ADESINA INSTITUTION OF TECHNOLOGY');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by OLUOKUN KABIRU ADESINA");
}
