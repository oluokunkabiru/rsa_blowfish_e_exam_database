    ...
    $.extend($.summernote.plugins,{
        'math':function(context){
            ...
            self.initialize = function(){
                ...
                // let documentUrl = window.location.hostname+includes/Mathematical_function_documentation.pdf
                let body=`<div class="form-group">

                    <p>Type <a href="../../../includes/Mathematical_function_documentation.pdf" target=_blank">Save your equation in KaTeX format</a> here: </p>
