      ...
      <div class="content-wrapper">
        <section class="content">
          <div class="container-fluid">
            ...
            <?php
            $student = new Users;
            $tstudent = $student->query("SELECT COUNT(id) AS totalstudent FROM student");
            ...
            <section>
              <div class="row">
                ...
                <div class="col-lg-3 col-6">
                  ...
                  <?php
                  $staff = new Users;
                  $tstaff = $staff->query("SELECT COUNT(id) AS totalstaff FROM teachers ");
                ...
                <div class="col-lg-3 col-6">
                  ...
                  $q = $examinations->query("SELECT COUNT(id) AS totalex FROM examinations");
                ...
                <div class="col-lg-3 col-6">
                  ...
                  $today = date('Y-m-d');
                  $examinations = new Questions;
                  $q = $examinations->query("SELECT COUNT(id) AS incomming FROM examinations WHERE enddate > '$today'");
                ...
                <div class="card card-primary card-outline">
                  <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                      ...
                      <li class="list-group-item">
                        <a href="schools-info/" class="btn btn-block btn-lg btn-rounded text-uppercase btn-primary">school info</a>
                      </li>
                    </ul>
                  </div>
                  <!-- /.card-body -->
