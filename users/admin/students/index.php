          ...
          <div class="container-fluid">
            ...
            <div class="col-md-6 col-sm-8">
              ...
              <div class="input-group mb-3">
               ...
               <div class="my-2">
            <a href="studentclass.php" class="btn btn-rounded btn-block btn-primary text-uppercase">go to class</a>
            </div>
            </div>
            ...
            <?php
             ...
             ON subjects.subjectid = examinations.subjectid WHERE examinations.startdate >= '$today' OR examinations.enddate <= '$today' ORDER BY enddate DESC ");
             $i = 1;
