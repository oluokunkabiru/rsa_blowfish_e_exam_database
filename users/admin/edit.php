...
if (count($error) > 0) {
 ...
 if(count($error)==0){
    ...
    $public = $exam->test_input($exam->rsaPublic($private));
     ...
     $q = $exam->query("UPDATE examinations SET subjectid ='$subject', rsa_public='$public', rsa_private='$private',  display='$display', classid='$classname', description='$examinationdescription', 
