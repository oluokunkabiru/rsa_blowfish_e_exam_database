      ...
      <span class="brand-text font-weight-light"><?= strtoupper($acronyms) ?> </span>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="<?= ADMIN ?>" class="d-block text-uppercase">
                        <?php echo $name ?>
                    </a>
                </div>
            </div>
               ...
               with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= MANAGE_STAFF ?>" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= MANAGE_CLASS ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Managed Class</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= MANAGE_SUBJECT ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Managed Subject</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= MANAGE_EXAMINATION ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?= ACTIVE_LOGIN_USER ?>" class="nav-link">
