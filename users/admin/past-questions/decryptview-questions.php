...
?>
    ...
    <head>
        ...
        <title>DECRYPTED EXAMINATION QUESTION</title>
            ...
            <div class="content-wrapper">
                <section class="content">
                    ...
                    ON subjects.subjectid = examinations.subjectid WHERE examinationid='$examinationid'");
                            ...
                            // $past_question = 
                            $key = $past->rsaPublic($exams['rsa_public']) ;
                            ...
                            <div id="printpastquestion">
                                ...
                                <div class="row" style="">
                                    ...
                                    <div class="col-md-3">
                                        <a href="past.php?examinationid=<?php echo $examinationid ?>" class="btn btn-primary">Download Past question <span class="ml-2 fa fa-download"></span></a>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <h1 class="text-center text-uppercase font-weight-bold mt-2 mb-2"> Decrypted questions </h1>
                                <?php
                                ...
                                ?>
                                    ...
                                    <div class="card mt-2">
                                        <div class="card-header">
                                            ...
                                            <?php echo html_entity_decode($exam->DecyptRSA($data['question'], $key)) ?>
                                        </div>
                                        <div class="card-body">
                                            <?php
                                            if ($data['option_a'] != "") {
                                                ...
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="optiona">
                                                        ...
                                                        A. <span class="ml-2 text-secondary questionoption"><span style="display: inline;">
                                                                ...
                                                                <!-- $past_question.=' -->
                                                            </span><?php echo   html_entity_decode($exam->DecyptRSA($data['option_a'], $key)) ?>
                                                ...
                                                ?>
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label" for="optionb"> B. <span class="ml-2 text-secondary questionoption">
                                                                ...
                                                                echo html_entity_decode($exam->DecyptRSA($data['option_b'], $key))
                                                                ?></span> </label>
                                                    </div>
                                                <?php }
                                                ...
                                                ?>
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label" for="optionc"> C. <span class="ml-2 text-secondary questionoption">
                                                                ...
                                                                echo html_entity_decode($exam->DecyptRSA($data['option_c'], $key))  ?></span> </label>
                                                    </div>
                                                <?php
                                                }
                                                ...
                                                ?>
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label" for="optiond"> D. <span class="ml-2 text-secondary questionoption">
                                                                ...
                                                                echo html_entity_decode($exam->DecyptRSA($data['option_d'], $key)) ?></span> </label>
                                                    </div>
                                                <?php
                                                }
                                                ...
                                                ?>
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label" for="optione"> E. <span class="ml-2 text-secondary questionoption">
                                                                ...
                                                                echo  html_entity_decode($exam->DecyptRSA($data['option_e'], $key)) ?></span>
