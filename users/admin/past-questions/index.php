...
?>
  ...
  <head>
    ...
    <title>MANAGED EXAMINATION PAST QUESTIONS</title>
      ...
      <div class="content-wrapper">
        <section class="content">
          <div class="container-fluid">
            <h2 class="text-center text-uppercase font-weight-bold mt-2 mb-2">Past Examination</h2>
           <div class="row">
            <?php
             ...
             ON subjects.subjectid = examinations.subjectid WHERE examinations.enddate < '$today' ORDER BY enddate DESC ");
             $i = 1;
