...
$handle = fopen($file, "r");
        ...
        if($questioni !=""){
            ...
            $questions  = $question->RSAEncrypt($question->setQuestion($questioni), $key);
              $optiona = $question->RSAEncrypt($question->setQuestion($optionas), $key);
              $optionb = $question->RSAEncrypt($question->setQuestion($optionbs), $key);
              $optionc = $question->RSAEncrypt($optioncs?$question->setQuestion($optioncs):"", $key);
              $optiond = $question->RSAEncrypt($optionds?$question->setQuestion($optionds):"", $key);
              $optione = $question->RSAEncrypt($optiones?$question->setQuestion($optiones):"", $key);
              $qtype = "file";
              $correctanswer = $question->RSAEncrypt(ucwords($question->test_input($corrects)), $key);;
              $mark = $question->RSAEncrypt($question->test_input($marks), $key);;
                 $examid = $_POST['examid'];
