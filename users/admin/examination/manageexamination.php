                ...
                ON subjects.subjectid = examinations.subjectid ORDER BY startdate DESC ");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $data['rsa_private'] ?></td>
                      <td><?php echo $data['rsa_public'] ?></td>
                      ...
                      <td>
                        ...
                        ?>
                          ...
                          <a href="../past-questions/view-questions.php?examinationid=<?php echo  $data['examinationid'] ?>" class="btn btn-sm btn-warning m-1"><span class="fa fa-lock p-2"></span></a>
                          <a href="../past-questions/decryptview-questions.php?examinationid=<?php echo  $data['examinationid'] ?>" class="btn btn-sm btn-warning m-1"><span class="fa fa-key p-2"></span></a>
                  ...
                  <div class="card card-info">
                    ...
                    <form class="form-horizontal" id="newexaminationform">
                      <div class="card-body">
                        ...
                        <div class="form-group row">
                          <label for="" class="col-sm-4 col-form-label">BlowFish Key <small class="text-danger">Symmentric Key</small> </label>
                          <div class="col-sm-8">
