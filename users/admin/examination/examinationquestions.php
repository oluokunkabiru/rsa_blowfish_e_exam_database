                               ...
                               <a href="manageexamination.php" class="btn btn-primary float-right text-uppercase btn-lg p-2">Manage question</a>
                                <table id="tables" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $exam = new Examination;
                                        $q = $exam->query("SELECT questions.*, examinations.duration as duration FROM questions JOIN examinations ON questions.examinationid = examinations.examinationid WHERE examinations.examinationid = '$id' ORDER BY questions.id ASC");
                                        $i = 1;
                                        ...
                                        ?>
                                            ...
                                            <td><?php echo html_entity_decode($exam->DecyptRSA($data['question'], $key)) ?></td>
                                            <td><span class="text-center"><?php echo html_entity_decode($exam->DecyptRSA($data['option_a'], $key))?></span></td>
                                            <td><span class="text-center"><?php echo html_entity_decode($exam->DecyptRSA($data['option_b'], $key))?></span></td>
                                            <td><span class="text-center"><?php echo html_entity_decode($exam->DecyptRSA($data['option_c'], $key))?></span></td>
                                            <td><span class="text-center"><?php echo html_entity_decode($exam->DecyptRSA($data['option_d'], $key))?></span></td>
                                            <td><span class="text-center"><?php echo html_entity_decode($exam->DecyptRSA($data['option_e'], $key))?></span></td>
                                            <td><span class="text-uppercase"><?php echo html_entity_decode($exam->DecyptRSA($data['correct'], $key))?></span></td>

                                            <td><?php echo html_entity_decode($exam->DecyptRSA($data['mark'], $key)) ?></td>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 py-4">
                                        ...
                                        <div class="card card-dark">
                                            ...
                                            <h3 class="msg font-weight-bold"></h3>
                                                

                                                <table class="table table-sm excelfilemsg">
                                                </table>
                                                
                                                <div class="container p-4">
                                                    <form id="fileformquestion" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label for="usr">Upload Questions in excel:  <a href="<?=BASE_URL?>includes/cbt_questions-format.csv" class="btn btn-sm btn-danger" download>Download exam format</a></label>
                    ...
                    <form class="form-horizontal" id="editexaminationquestionform" enctype="multipart/form-data" >
                        <div class="card-body">
                           ...
                           <input type="hidden" value="<?php $question['questiontype'] ?>" name="qtype">
                            ...
                            <?php echo $question['question']?html_entity_decode($exam->DecyptRSA($question['question'], $key)):"" ?>
                            </textarea>
                                </div>

                            </div>
                                <input type="hidden" name="editquestionsid" value="<?php echo $_GET['editquestions'] ?>">
                                <input type="hidden" name="exampin" value="<?= $key ?>">
                                <div class="row">
                                <div class="col">
                                    <div class="form-group row">
                                <label for="options" class="col-sm-4 col-form-label">Option A</label>
                                ...
                                <?php if(!empty($question['option_a'])){ echo html_entity_decode($exam->DecyptRSA($question['option_a'], $key)); }?>
                                ...
                                <?php if(!empty($question['option_b'])){ echo html_entity_decode($exam->DecyptRSA($question['option_b'], $key)); }?>
                           ...
                           <div class="row">
                               <div class="col">
                                ...
                                <?php if(!empty($question['option_c'])){ echo html_entity_decode($exam->DecyptRSA($question['option_c'], $key)); }?>
                               ...
                               <div class="col">
                                ...
                                <?php if(!empty($question['option_d'])){ echo html_entity_decode($exam->DecyptRSA($question['option_d'], $key)); }?>
                            ...
                            <div class="row">
                                ...
                                <?php if( !empty($question['option_e'])){ echo html_entity_decode($exam->DecyptRSA($question['option_e'], $key)); }?>
                                ...
                                <label for="" class="col-sm-4 col-form-label">Mark</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" value="<?php echo $exam->DecyptRSA($question['mark'] , $key)?>" name="mark" placeholder="Assign mark">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-4 col-form-label">Correct Answer </label>
                                <div class="col-sm-8">
                                    <select class="custom-select" name="correct">
                                    <option value="<?php echo $question['correct'] ?>" selected class="text-uppercase"><?php echo html_entity_decode($exam->DecyptRSA($question['correct'], $key)) ?></option>
...
<?php
        ...
        header('location:'. MANAGE_EXAMINATION);
    }
    include('../script.php');
} else {
