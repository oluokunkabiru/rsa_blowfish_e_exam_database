              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><img src="../<?php echo !empty($data['avatar'])?$data['avatar']:"../../students_avatar/avatar.png" ?>" class="rounded" style="width: 60px;" alt="<?php echo $data['username'] ?>"></td>
                    <td><img src="../<?php echo !empty($data['photo'])?$data['photo']:"../../students_avatar/avatar.png" ?>" class="rounded" style="width: 80px;" alt="<?php echo $data['username'] ?>"></td>
